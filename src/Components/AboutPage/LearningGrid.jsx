...
function LearningGrid() {
  return (
    <div className="grid mx-auto lg:grid-cols-4 grid-col-1 mb-10 max-w-maxContent w-11/12 ">
      {LearningGridArray.map((card, index) => {
        return (
          <div 
            key={index}
            className={`${index == 0 && "lg:col-span-2 lg:h-[250px] bg-transparent"} ${
 ...
 <div className="w-fit mt-4">
              ...
              <div className="flex flex-col gap-5 mt-5 max-w-[80%] mx-auto">
